...
if (new MeshReadMetadata(602, 480, 1) != factory.AssetLoader.ReadMeshMetadata(CommonTestAssets.FindAsset(KnownTestAsset.CrateMesh))) throw new InvalidOperationException($"Test fail (metadata = {factory.AssetLoader.ReadMeshMetadata(CommonTestAssets.FindAsset(KnownTestAsset.CrateMesh))})");
