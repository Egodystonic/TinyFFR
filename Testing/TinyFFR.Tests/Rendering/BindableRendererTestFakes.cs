...
sealed class FakeSceneImplProvider : ISceneImplProvider {
	...
	public XYPair<int> GetCanvasObjectSizePixels(ResourceHandle<Scene> handle, ModelInstance modelInstance) => throw new NotSupportedException();
	public void SetCanvasObjectSizePixels(ResourceHandle<Scene> handle, ModelInstance modelInstance, XYPair<int> newValue) => throw new NotSupportedException();
	public XYPair<float> GetCanvasObjectSizeFraction(ResourceHandle<Scene> handle, ModelInstance modelInstance) => throw new NotSupportedException();
	public void SetCanvasObjectSizeFraction(ResourceHandle<Scene> handle, ModelInstance modelInstance, XYPair<float> newValue) => throw new NotSupportedException();
	...
	public FontString GetCanvasTextString(ResourceHandle<Scene> handle, TextInstance text) => throw new NotSupportedException();
