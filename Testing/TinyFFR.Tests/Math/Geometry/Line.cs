...
class LineTest {
	...
	public void ShouldCorrectlyDeterminePhysicalValidity() {
		Assert.AreEqual(true, new Line(Location.Origin, Direction.Forward).IsPhysicallyValid);
		Assert.AreEqual(false, new Line(Location.Origin, Direction.None).IsPhysicallyValid);
	}
	...
	public void ShouldCorrectlyCalculateDistanceFromLines() { // These are regression tests
		...
		Assert.AreEqual(
			17.34369f,
			TestLine.DistanceFrom(new BoundedRay(new Location(15f, -3f, 12f), new Direction(-2f, 0f, 14f) * -4f)),
			TestTolerance
		);
		...
		Assert.AreEqual(
			17.34369f * 17.34369f,
			TestLine.DistanceSquaredFrom(new BoundedRay(new Location(15f, -3f, 12f), new Direction(-2f, 0f, 14f) * -4f)),
			TestTolerance
		);
	...
	public void ShouldCorrectlyParallelizeWithDirectionsAndLineLikesUsingSpecifiedPivotPoint() {
		void AssertAgainstLeft(Line? expectation, Line input, float pivotPointDistance) {
			...
			AssertToleranceEquals(expectation, input.ParallelizedWith(new BoundedRay(Location.Origin, new Location(1f, 0f, 0f)), pivotPointDistance), TestTolerance);
		}
		void AssertFastAgainstLeft(Line expectation, Line input, float pivotPointDistance) {
			...
			AssertToleranceEquals(expectation, input.FastParallelizedWith(new BoundedRay(Location.Origin, new Location(1f, 0f, 0f)), pivotPointDistance), TestTolerance);
		}
	...
	public void ShouldCorrectlyOrthogonalizeAgainstDirectionsAndLineLikesUsingSpecifiedPivotPoint() {
		void AssertAgainstLeft(Line? expectation, Line input, float pivotPointDistance) {
			...
			AssertToleranceEquals(expectation, input.OrthogonalizedAgainst(new BoundedRay(Location.Origin, new Location(1f, 0f, 0f)), pivotPointDistance), TestTolerance);
		}
		void AssertFastAgainstLeft(Line expectation, Line input, float pivotPointDistance) {
			...
			AssertToleranceEquals(expectation, input.FastOrthogonalizedAgainst(new BoundedRay(Location.Origin, new Location(1f, 0f, 0f)), pivotPointDistance), TestTolerance);
		}
	...
	public void ShouldCorrectlyDetermineAngleToOtherLines() {
		void AssertAngle(float signedExpectedAngle, Direction clockwiseSignedDir, Direction thisDir, Direction otherDir) {
			var a = new Line(Location.Origin, thisDir);
