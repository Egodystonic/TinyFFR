...
class TranslatedShapeTest {
	...
	static readonly TranslatedConvexShape<Sphere> TestShape = new(new Sphere(7.4f), new Location(1f, -2f, 3f));
	...
	public void ShouldCorrectlyDeterminePhysicalValidity() {
		Assert.AreEqual(true, new TranslatedConvexShape<Sphere>(new Sphere(1f), Location.Origin).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(-1f), Location.Origin).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(0f), Location.Origin).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(Single.NaN), Location.Origin).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(Single.PositiveInfinity), Location.Origin).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(Single.NegativeInfinity), Location.Origin).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(Single.NegativeZero), Location.Origin).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(1f), new Location(Single.NaN, 0f, 0f)).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(1f), new Location(0f, Single.PositiveInfinity, 0f)).IsPhysicallyValid);
	}
	...
	public void ShouldCorrectlyInterpolate() {
		var start = new TranslatedConvexShape<Sphere>(new Sphere(5f), new Location(0f, 0f, 0f));
		var end = new TranslatedConvexShape<Sphere>(new Sphere(15f), new Location(10f, 10f, 10f));
		Assert.AreEqual(new TranslatedConvexShape<Sphere>(new Sphere(10f), new Location(5f, 5f, 5f)), TranslatedConvexShape<Sphere>.Interpolate(start, end, 0.5f));
		...
		Assert.AreEqual(new TranslatedConvexShape<Sphere>(new Sphere(20f), new Location(15f, 15f, 15f)), TranslatedConvexShape<Sphere>.Interpolate(start, end, 1.5f));
		Assert.AreEqual(new TranslatedConvexShape<Sphere>(new Sphere(0f), new Location(-5f, -5f, -5f)), TranslatedConvexShape<Sphere>.Interpolate(start, end, -0.5f));
	}

	[Test]
	public void ShouldCorrectlyClamp() {
		var min = new TranslatedConvexShape<Sphere>(new Sphere(5f), new Location(-5f, -5f, -5f));
		var max = new TranslatedConvexShape<Sphere>(new Sphere(15f), new Location(5f, 5f, 5f));
		var mid = new TranslatedConvexShape<Sphere>(new Sphere(10f), new Location(0f, 0f, 0f));
		Assert.AreEqual(mid, mid.Clamp(min, max));
		Assert.AreEqual(mid, mid.Clamp(max, min));
		Assert.AreEqual(max, new TranslatedConvexShape<Sphere>(new Sphere(20f), new Location(10f, 10f, 10f)).Clamp(min, max));
		Assert.AreEqual(max, new TranslatedConvexShape<Sphere>(new Sphere(20f), new Location(10f, 10f, 10f)).Clamp(max, min));
		Assert.AreEqual(min, new TranslatedConvexShape<Sphere>(new Sphere(0f), new Location(-10f, -10f, -10f)).Clamp(min, max));
		Assert.AreEqual(min, new TranslatedConvexShape<Sphere>(new Sphere(0f), new Location(-10f, -10f, -10f)).Clamp(max, min));
	}
	...
	public void ShouldCorrectlyCreateRandomObjects() {
		...
		var min = new TranslatedConvexShape<Sphere>(new Sphere(10f), new Location(-10f, -10f, -10f));
		var max = new TranslatedConvexShape<Sphere>(new Sphere(20f), new Location(10f, 10f, 10f));
