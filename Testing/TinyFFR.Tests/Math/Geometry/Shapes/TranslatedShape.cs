...
[TestFixture]
class TranslatedShapeTest {
	const float TestTolerance = 0.01f;
	static readonly TranslatedConvexShape<Sphere> TestShape = new(new Sphere(7.4f), new Vect(1f, -2f, 3f));
	...
	public void ShouldCorrectlyDeterminePhysicalValidity() {
		Assert.AreEqual(true, new TranslatedConvexShape<Sphere>(new Sphere(1f), Vect.Zero).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(-1f), Vect.Zero).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(0f), Vect.Zero).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(Single.NaN), Vect.Zero).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(Single.PositiveInfinity), Vect.Zero).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(Single.NegativeInfinity), Vect.Zero).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(Single.NegativeZero), Vect.Zero).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(1f), new Vect(Single.NaN, 0f, 0f)).IsPhysicallyValid);
		Assert.AreEqual(false, new TranslatedConvexShape<Sphere>(new Sphere(1f), new Vect(0f, Single.PositiveInfinity, 0f)).IsPhysicallyValid);
	}
	...
	public void ShouldCorrectlyParse() {
		...
		Assert.AreEqual(TestShape, TranslatedConvexShape<Sphere>.Parse(Input, CultureInfo.InvariantCulture));
		Assert.AreEqual(true, TranslatedConvexShape<Sphere>.TryParse(Input, CultureInfo.InvariantCulture, out var result));
	...
	public void ShouldCorrectlyConvertToAndFromSpan() {
		...
		ByteSpanSerializationTestUtils.AssertLittleEndianSingles(TestShape, TestShape.BaseShape.Radius, TestShape.Translation.X, TestShape.Translation.Y, TestShape.Translation.Z);
	}

	[Test]
	public void ShouldCorrectlyInterpolate() {
		var start = new TranslatedConvexShape<Sphere>(new Sphere(5f), new Vect(0f, 0f, 0f));
		var end = new TranslatedConvexShape<Sphere>(new Sphere(15f), new Vect(10f, 10f, 10f));
		Assert.AreEqual(new TranslatedConvexShape<Sphere>(new Sphere(10f), new Vect(5f, 5f, 5f)), TranslatedConvexShape<Sphere>.Interpolate(start, end, 0.5f));
		Assert.AreEqual(start, TranslatedConvexShape<Sphere>.Interpolate(start, end, 0f));
		Assert.AreEqual(end, TranslatedConvexShape<Sphere>.Interpolate(start, end, 1f));
		Assert.AreEqual(new TranslatedConvexShape<Sphere>(new Sphere(20f), new Vect(15f, 15f, 15f)), TranslatedConvexShape<Sphere>.Interpolate(start, end, 1.5f));
		Assert.AreEqual(new TranslatedConvexShape<Sphere>(new Sphere(0f), new Vect(-5f, -5f, -5f)), TranslatedConvexShape<Sphere>.Interpolate(start, end, -0.5f));
	}

	[Test]
	public void ShouldCorrectlyClamp() {
		var min = new TranslatedConvexShape<Sphere>(new Sphere(5f), new Vect(-5f, -5f, -5f));
		var max = new TranslatedConvexShape<Sphere>(new Sphere(15f), new Vect(5f, 5f, 5f));
		var mid = new TranslatedConvexShape<Sphere>(new Sphere(10f), new Vect(0f, 0f, 0f));
		Assert.AreEqual(mid, mid.Clamp(min, max));
		Assert.AreEqual(mid, mid.Clamp(max, min));
		Assert.AreEqual(max, new TranslatedConvexShape<Sphere>(new Sphere(20f), new Vect(10f, 10f, 10f)).Clamp(min, max));
		Assert.AreEqual(max, new TranslatedConvexShape<Sphere>(new Sphere(20f), new Vect(10f, 10f, 10f)).Clamp(max, min));
		Assert.AreEqual(min, new TranslatedConvexShape<Sphere>(new Sphere(0f), new Vect(-10f, -10f, -10f)).Clamp(min, max));
		Assert.AreEqual(min, new TranslatedConvexShape<Sphere>(new Sphere(0f), new Vect(-10f, -10f, -10f)).Clamp(max, min));
	}
	...
	public void ShouldCorrectlyCreateRandomObjects() {
		...
		var min = new TranslatedConvexShape<Sphere>(new Sphere(10f), new Vect(-10f, -10f, -10f));
		var max = new TranslatedConvexShape<Sphere>(new Sphere(20f), new Vect(10f, 10f, 10f));
		for (var i = 0; i < NumIterations; ++i) {
			var val = TranslatedConvexShape<Sphere>.Random(min, max);
	...
	public void ShouldCorrectlyFindClosestPointOnSurfaceToGivenLocation() {
		...
		Assert.AreEqual(7.4f, TestShape.SurfacePointClosestTo(new Location(1f, -2f, 3f)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
	}
	...
	public void ShouldCorrectlyFindClosestPointOnSurfaceToLine() {
		Assert.AreEqual(7.4f, TestShape.SurfacePointClosestTo(new Line((1f, -2f, 3f), Direction.Backward)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		...
		Assert.AreEqual(7.4f, TestShape.SurfacePointClosestTo(new Ray((1f, -2f, 3f), Direction.Down)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		...
		Assert.AreEqual(7.4f, TestShape.SurfacePointClosestTo(new Ray((1f, 15.4f, 3f), Direction.Down)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		Assert.AreEqual(7.4f, TestShape.SurfacePointClosestTo(new Ray((1f, -19.4f, 3f), Direction.Up)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		...
		Assert.AreEqual(7.4f, TestShape.SurfacePointClosestTo(new BoundedRay((1f, -2f, 3f), Direction.Down * 100f)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		Assert.AreEqual(7.4f, TestShape.SurfacePointClosestTo(new BoundedRay((1f, 5.4f, 3f), Direction.Down * 100f)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		Assert.AreEqual(7.4f, TestShape.SurfacePointClosestTo(new BoundedRay((1f, -9.4f, 3f), Direction.Up * 100f)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		Assert.AreEqual(7.4f, TestShape.SurfacePointClosestTo(new BoundedRay((1f, 15.4f, 3f), Direction.Down * 100f)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		Assert.AreEqual(7.4f, TestShape.SurfacePointClosestTo(new BoundedRay((1f, -19.4f, 3f), Direction.Up * 100f)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		...
		Assert.AreEqual(7.4f, TestShape.SurfacePointClosestTo(new BoundedRay(new Location(0f, -2f, 3f), new Location(2f, -2f, 3f))).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
	...
	public void ShouldCorrectlyFindClosestPointOnLineToSurface() {
		Assert.AreEqual(7.4f, TestShape.ClosestPointToSurfaceOn(new Line((1f, -2f, 3f), Direction.Backward)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		...
		Assert.AreEqual(7.4f, TestShape.ClosestPointToSurfaceOn(new Ray((1f, -2f, 3f), Direction.Down)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		...
		Assert.AreEqual(7.4f, TestShape.ClosestPointToSurfaceOn(new Ray((1f, 15.4f, 3f), Direction.Down)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		Assert.AreEqual(7.4f, TestShape.ClosestPointToSurfaceOn(new Ray((1f, -19.4f, 3f), Direction.Up)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		...
		Assert.AreEqual(7.4f, TestShape.ClosestPointToSurfaceOn(new BoundedRay((1f, -2f, 3f), Direction.Down * 100f)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		Assert.AreEqual(7.4f, TestShape.ClosestPointToSurfaceOn(new BoundedRay((1f, 5.4f, 3f), Direction.Down * 100f)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		Assert.AreEqual(7.4f, TestShape.ClosestPointToSurfaceOn(new BoundedRay((1f, -9.4f, 3f), Direction.Up * 100f)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		Assert.AreEqual(7.4f, TestShape.ClosestPointToSurfaceOn(new BoundedRay((1f, 15.4f, 3f), Direction.Down * 100f)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		Assert.AreEqual(7.4f, TestShape.ClosestPointToSurfaceOn(new BoundedRay((1f, -19.4f, 3f), Direction.Up * 100f)).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		...
		Assert.AreEqual(1f, TestShape.ClosestPointToSurfaceOn(new BoundedRay(new Location(0f, -2f, 3f), new Location(2f, -2f, 3f))).DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
	...
	public void ShouldCorrectlyFindLineIntersections() {
		...
		Assert.AreEqual(7.4f, intersection.First.DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
		Assert.AreEqual(4f, intersection.First.Y, TestTolerance);
		Assert.AreEqual(7.4f, intersection.Second!.Value.DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
	...
	public void ShouldCorrectlyDetermineClosestSurfacePointToPlanes() {
		...
		Assert.AreEqual(7.4f, closestPoint.DistanceFrom(TestShape.Translation.AsLocation()), TestTolerance);
	...
	public void ShouldCorrectlyDetermineIncidentAngleWithLines() {
		...
		AssertAngle(Angle.Zero, Direction.Down, TestShape.Translation.AsLocation());
		AssertAngle(Angle.Zero, (1f, 1f, 1f), TestShape.Translation.AsLocation());
		...
		AssertAngle(30f, Direction.Down, (1f + TestShape.BaseShape.Radius * -0.5f, -2f, 3f));
		AssertAngle(30f, (-1f, -1f, -1f), TestShape.Translation.AsLocation() + new Direction(-1f, -1f, -1f).AnyOrthogonal() * (TestShape.BaseShape.Radius * 0.5f));
	...
	public void ShouldCorrectlyReflectLines() {
		...
		AssertReflection(new((1f, -2f + TestShape.BaseShape.Radius, 3f), Direction.Up), Direction.Down, TestShape.Translation.AsLocation());
		AssertReflection(new(TestShape.Translation.AsLocation() + new Direction(-1f, -1f, -1f) * TestShape.BaseShape.Radius, (-1f, -1f, -1f)), (1f, 1f, 1f), TestShape.Translation.AsLocation());
		...
		AssertReflection(
			...
			(1f, 1f, 1f),
			TestShape.Translation.AsLocation()
		);
