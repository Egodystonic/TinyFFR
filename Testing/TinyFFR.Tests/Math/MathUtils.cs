...
class MathUtilsTest {
	...
	public void ShouldThrowForInvalidCanvasOrigin() {
		Assert.Throws<ArgumentOutOfRangeException>(() => FindAnchoredPointIn2DCoordinateSystem(XYPair<int>.One, (DiagonalOrientation2D) 1234567, Orientation2D.UpRight, XYPair<int>.Zero));
		Assert.Throws<ArgumentOutOfRangeException>(() => FindAnchoredAreaIn2DCoordinateSystem(XYPair<int>.One, (DiagonalOrientation2D) 1234567, Orientation2D.UpRight, XYPair<int>.Zero, XYPair<int>.One));
	}
	...
	public void ShouldCorrectlyTranslateAnchoredCanvasOffsetForCentreOrigin() {
		...
		void AssertCombination(XYPair<int> expectation, Orientation2D anchor, XYPair<int> offset) {
			Assert.AreEqual(
				expectation,
				FindAnchoredPointIn2DCoordinateSystem(canvasSize, DiagonalOrientation2D.None, anchor, offset)
			);
		}
	...
	public void ShouldCorrectlyGetAnchoredCanvasAreaStartCoordForCentreOrigin() {
		...
		void AssertCombination(XYPair<int> expectation, Orientation2D anchor) {
			Assert.AreEqual(
				expectation,
				FindAnchoredAreaIn2DCoordinateSystem(canvasSize, DiagonalOrientation2D.None, anchor, offset, area)
			);
		}
	...
	public void ShouldCorrectlyTranslateAnchoredCanvasOffsetNormalizedForCentreOrigin() {
		void AssertCombination(XYPair<float> expectation, Orientation2D anchor) {
			Assert.AreEqual(
				expectation,
				FindAnchorInNormalized2DCoordinateSystem(DiagonalOrientation2D.None, anchor)
			);
		}
	...
	public void ShouldCorrectlyTranslateAnchoredCanvasOffset() {
		...
		void AssertCombination(XYPair<int> expectation, DiagonalOrientation2D origin, Orientation2D anchor) {
			Assert.AreEqual(
				expectation,
				FindAnchoredPointIn2DCoordinateSystem(canvasSize, origin, anchor, offset)
			);
		}
	...
	public void ShouldCorrectlyGetAnchoredCanvasAreaStartCoord() {
		...
		void AssertCombination(XYPair<int> expectation, DiagonalOrientation2D origin, Orientation2D anchor, XYPair<int> area) {
			Assert.AreEqual(
				expectation,
				FindAnchoredAreaIn2DCoordinateSystem(canvasSize, origin, anchor, offset, area)
			);
		}
