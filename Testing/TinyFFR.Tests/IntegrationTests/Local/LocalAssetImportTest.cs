...
class LocalAssetImportTest {
	...
	public void Execute() {
		...
		Assert.AreEqual(new MeshReadMetadata(602, 480, 1), factory.AssetLoader.ReadMeshMetadata(CommonTestAssets.FindAsset(KnownTestAsset.CrateMesh)));
		...
		using var cubemap = factory.AssetLoader.LoadBackdropTexture(CommonTestAssets.FindAsset(KnownTestAsset.CloudsHdr), new BackdropTextureCreationConfig(), Quality.VeryLow);
