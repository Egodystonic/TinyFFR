...
public interface IResourceSpecialization<TSelf, TBase> where TSelf : IResourceSpecialization<TSelf, TBase> where TBase : IResource<TBase> {
	...
	internal static abstract void Smuggle(TSelf resource, Memory<byte> specializationDataBuffer, out TBase outBaseResource);
	internal static abstract TSelf DeSmuggle(TBase baseResource, ReadOnlyMemory<byte> specializationDataBuffer);
}