...
public readonly partial struct Sphere : IShape<Sphere>, IConvexShape/*, IPlaneIntersectableShape<Circle>*/ {
	...
	public static Sphere FromDiameter(float diameter) => new(diameter / 2f);
