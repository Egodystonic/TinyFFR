...
/// <summary>
/// A scene used for flat, two-dimensional content drawn over the screen/render (e.g. text, images and other user-interface elements).
/// Created via the factory's <see cref="ISceneBuilder"/>.
/// </summary>
/// <remarks>
/// <para>
