...
public interface ILightBuilder {
	...
	SpotLight CreateSpotLight(Location? position = null, Direction? coneDirection = null, Angle? coneAngle = null, Angle? intenseBeamAngle = null, ColorVect? color = null, float? brightness = null, float? maxDistance = null, bool? highQuality = null, ReadOnlySpan<char> name = default) {
	...
	DirectionalLight CreateDirectionalLight(Direction? direction = null, ColorVect? color = null, float? brightness = null, bool? showSunDisc = null, ReadOnlySpan<char> name = default) {
