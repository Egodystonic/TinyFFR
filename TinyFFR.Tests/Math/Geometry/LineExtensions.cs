...
// 		static void Test(Line line, BoundedRay line2) {
// 			line.DistanceFrom(new OriginSphere());
// 			new Plane().IntersectionWith(line);
// 			line.PointClosestTo(new Ray());
// 			line.PointClosestTo(line2);
// 			line.PointClosestTo(new OriginSphere());
// 			line.PointClosestTo(Location.Origin);
// 			line.PointClosestTo(new Plane());
// 			new Ray().PointClosestTo(new OriginSphere());
//
// 			new Ray().PointClosestTo(line);
// 			new Line().PointClosestTo(line);
// 			new Line().PointClosestTo(new Line());
// 			new OriginSphere().PointClosestTo(line);
// 			Location.Origin.ClosestPointOnSurfaceOf(new OriginSphere());
// 			new Plane().PointClosestTo(line);
//
...
// 			new OriginSphere().SurfacePointClosestTo(new Plane());
...
// 			AssertGenericMethodInvoked(lineClosestSurfacePointDiscoverable, nameof(ILineClosestPointDiscoverable.PointClosestTo), genericLine);
// 			_ = genericLine.PointClosestTo(lineClosestSurfacePointDiscoverable);
...
// 		_ = lineClosestSurfacePointDiscoverable.Received(0).SurfacePointClosestTo(line);
// 		_ = lineClosestSurfacePointDiscoverable.Received(0).ClosestPointToSurfaceOn(line);
// 		_ = line.PointClosestTo(lineClosestSurfacePointDiscoverable);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).PointClosestTo(line);
...
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).PointClosestTo(line);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).ClosestPointOn(line);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).SurfacePointClosestTo(line);
// 		_ = lineClosestSurfacePointDiscoverable.Received(0).ClosestPointToSurfaceOn(line);
// 		_ = line.ClosestPointOnSurfaceOf(lineClosestSurfacePointDiscoverable);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).PointClosestTo(line);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).ClosestPointOn(line);
...
// 		_ = lineClosestSurfacePointDiscoverable.Received(0).SurfacePointClosestTo(ray);
// 		_ = lineClosestSurfacePointDiscoverable.Received(0).ClosestPointToSurfaceOn(ray);
// 		_ = ray.PointClosestTo(lineClosestSurfacePointDiscoverable);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).PointClosestTo(ray);
...
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).PointClosestTo(ray);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).ClosestPointOn(ray);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).SurfacePointClosestTo(ray);
// 		_ = lineClosestSurfacePointDiscoverable.Received(0).ClosestPointToSurfaceOn(ray);
// 		_ = ray.ClosestPointOnSurfaceOf(lineClosestSurfacePointDiscoverable);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).PointClosestTo(ray);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).ClosestPointOn(ray);
...
// 		_ = lineClosestSurfacePointDiscoverable.Received(0).SurfacePointClosestTo(boundedLine);
// 		_ = lineClosestSurfacePointDiscoverable.Received(0).ClosestPointToSurfaceOn(boundedLine);
// 		_ = boundedLine.PointClosestTo(lineClosestSurfacePointDiscoverable);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).PointClosestTo(boundedLine);
...
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).PointClosestTo(boundedLine);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).ClosestPointOn(boundedLine);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).SurfacePointClosestTo(boundedLine);
// 		_ = lineClosestSurfacePointDiscoverable.Received(0).ClosestPointToSurfaceOn(boundedLine);
// 		_ = boundedLine.ClosestPointOnSurfaceOf(lineClosestSurfacePointDiscoverable);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).PointClosestTo(boundedLine);
// 		_ = lineClosestSurfacePointDiscoverable.Received(1).ClosestPointOn(boundedLine);
