...
partial class OriginSphereTest {
	...
	public void ShouldCorrectlyDetermineDistanceFromLines() {
		...
		Assert.AreEqual(0f, TestSphere.DistanceFrom(new BoundedLine((0f, 0f, 0f), Direction.Down * 100f)));
		Assert.AreEqual(0f, TestSphere.DistanceFrom(new BoundedLine((0f, 7.4f, 0f), Direction.Down * 100f)));
		Assert.AreEqual(0f, TestSphere.DistanceFrom(new BoundedLine((0f, -7.4f, 0f), Direction.Up * 100f)));
		Assert.AreEqual(0f, TestSphere.DistanceFrom(new BoundedLine((0f, 17.4f, 0f), Direction.Down * 100f)));
		Assert.AreEqual(0f, TestSphere.DistanceFrom(new BoundedLine((0f, -17.4f, 0f), Direction.Up * 100f)));
		Assert.AreEqual(0f, TestSphere.DistanceFrom(new BoundedLine((0f, 7.4f, 0f), Direction.Up * 100f)));
		Assert.AreEqual(0f, TestSphere.DistanceFrom(new BoundedLine((0f, -7.4f, 0f), Direction.Down * 100f)));
		Assert.AreEqual(10f, TestSphere.DistanceFrom(new BoundedLine((0f, 17.4f, 0f), Direction.Up * 100f)));
		Assert.AreEqual(10f, TestSphere.DistanceFrom(new BoundedLine((0f, -17.4f, 0f), Direction.Down * 100f)));
		Assert.AreEqual(11f, TestSphere.DistanceFrom(new BoundedLine((0f, 27.4f, 0f), Direction.Down * 9f)));
		Assert.AreEqual(9f, TestSphere.DistanceFrom(new BoundedLine((0f, 27.4f, 0f), Direction.Down * 11f)));
	...
	public void ShouldCorrectlyDetermineSurfaceDistanceFromLines() {
		...
		Assert.AreEqual(0f, TestSphere.SurfaceDistanceFrom(new BoundedLine((0f, 0f, 0f), Direction.Down * 100f)), TestTolerance);
		Assert.AreEqual(0f, TestSphere.SurfaceDistanceFrom(new BoundedLine((0f, 7.4f, 0f), Direction.Down * 100f)), TestTolerance);
		Assert.AreEqual(0f, TestSphere.SurfaceDistanceFrom(new BoundedLine((0f, -7.4f, 0f), Direction.Up * 100f)), TestTolerance);
		Assert.AreEqual(0f, TestSphere.SurfaceDistanceFrom(new BoundedLine((0f, 17.4f, 0f), Direction.Down * 100f)), TestTolerance);
		Assert.AreEqual(0f, TestSphere.SurfaceDistanceFrom(new BoundedLine((0f, -17.4f, 0f), Direction.Up * 100f)), TestTolerance);
		Assert.AreEqual(0f, TestSphere.SurfaceDistanceFrom(new BoundedLine((0f, 7.4f, 0f), Direction.Up * 100f)), TestTolerance);
		Assert.AreEqual(0f, TestSphere.SurfaceDistanceFrom(new BoundedLine((0f, -7.4f, 0f), Direction.Down * 100f)), TestTolerance);
		Assert.AreEqual(10f, TestSphere.SurfaceDistanceFrom(new BoundedLine((0f, 17.4f, 0f), Direction.Up * 100f)), TestTolerance);
		Assert.AreEqual(10f, TestSphere.SurfaceDistanceFrom(new BoundedLine((0f, -17.4f, 0f), Direction.Down * 100f)), TestTolerance);
		Assert.AreEqual(11f, TestSphere.SurfaceDistanceFrom(new BoundedLine((0f, 27.4f, 0f), Direction.Down * 9f)), TestTolerance);
		Assert.AreEqual(9f, TestSphere.SurfaceDistanceFrom(new BoundedLine((0f, 27.4f, 0f), Direction.Down * 11f)), TestTolerance);
	...
	public void ShouldCorrectlyFindClosestPointToLine() {
		...
		AssertToleranceEquals((0f, 0f, 0f), TestSphere.ClosestPointTo(new BoundedLine((0f, 0f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 0f, 0f), TestSphere.ClosestPointTo(new BoundedLine((0f, 7.4f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 0f, 0f), TestSphere.ClosestPointTo(new BoundedLine((0f, -7.4f, 0f), Direction.Up * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 0f, 0f), TestSphere.ClosestPointTo(new BoundedLine((0f, 17.4f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 0f, 0f), TestSphere.ClosestPointTo(new BoundedLine((0f, -17.4f, 0f), Direction.Up * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 7.4f, 0f), TestSphere.ClosestPointTo(new BoundedLine((0f, 7.4f, 0f), Direction.Up * 100f)), TestTolerance);
		AssertToleranceEquals((0f, -7.4f, 0f), TestSphere.ClosestPointTo(new BoundedLine((0f, -7.4f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 7.4f, 0f), TestSphere.ClosestPointTo(new BoundedLine((0f, 17.4f, 0f), Direction.Up * 100f)), TestTolerance);
		AssertToleranceEquals((0f, -7.4f, 0f), TestSphere.ClosestPointTo(new BoundedLine((0f, -17.4f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 7.4f, 0f), TestSphere.ClosestPointTo(new BoundedLine((0f, 27.4f, 0f), Direction.Down * 9f)), TestTolerance);
	...
	public void ShouldCorrectlyFindClosestPointOnLine() {
		...
		AssertToleranceEquals((0f, 0f, 0f), TestSphere.ClosestPointOn(new BoundedLine((0f, 0f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 0f, 0f), TestSphere.ClosestPointOn(new BoundedLine((0f, 7.4f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 0f, 0f), TestSphere.ClosestPointOn(new BoundedLine((0f, -7.4f, 0f), Direction.Up * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 0f, 0f), TestSphere.ClosestPointOn(new BoundedLine((0f, 17.4f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 0f, 0f), TestSphere.ClosestPointOn(new BoundedLine((0f, -17.4f, 0f), Direction.Up * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 7.4f, 0f), TestSphere.ClosestPointOn(new BoundedLine((0f, 7.4f, 0f), Direction.Up * 100f)), TestTolerance);
		AssertToleranceEquals((0f, -7.4f, 0f), TestSphere.ClosestPointOn(new BoundedLine((0f, -7.4f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 17.4f, 0f), TestSphere.ClosestPointOn(new BoundedLine((0f, 17.4f, 0f), Direction.Up * 100f)), TestTolerance);
		AssertToleranceEquals((0f, -17.4f, 0f), TestSphere.ClosestPointOn(new BoundedLine((0f, -17.4f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 18.4f, 0f), TestSphere.ClosestPointOn(new BoundedLine((0f, 27.4f, 0f), Direction.Down * 9f)), TestTolerance);
	...
	public void ShouldCorrectlyFindClosestPointOnSurfaceToLine() {
		...
		Assert.AreEqual(7.4f, TestSphere.ClosestPointOnSurfaceTo(new BoundedLine((0f, 0f, 0f), Direction.Down * 100f)).DistanceFromOrigin(), TestTolerance);
		Assert.AreEqual(7.4f, TestSphere.ClosestPointOnSurfaceTo(new BoundedLine((0f, 7.4f, 0f), Direction.Down * 100f)).DistanceFromOrigin(), TestTolerance);
		Assert.AreEqual(7.4f, TestSphere.ClosestPointOnSurfaceTo(new BoundedLine((0f, -7.4f, 0f), Direction.Up * 100f)).DistanceFromOrigin(), TestTolerance);
		Assert.AreEqual(7.4f, TestSphere.ClosestPointOnSurfaceTo(new BoundedLine((0f, 17.4f, 0f), Direction.Down * 100f)).DistanceFromOrigin(), TestTolerance);
		Assert.AreEqual(7.4f, TestSphere.ClosestPointOnSurfaceTo(new BoundedLine((0f, -17.4f, 0f), Direction.Up * 100f)).DistanceFromOrigin(), TestTolerance);
		AssertToleranceEquals((0f, 7.4f, 0f), TestSphere.ClosestPointOnSurfaceTo(new BoundedLine((0f, 7.4f, 0f), Direction.Up * 100f)), TestTolerance);
		AssertToleranceEquals((0f, -7.4f, 0f), TestSphere.ClosestPointOnSurfaceTo(new BoundedLine((0f, -7.4f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 7.4f, 0f), TestSphere.ClosestPointOnSurfaceTo(new BoundedLine((0f, 17.4f, 0f), Direction.Up * 100f)), TestTolerance);
		AssertToleranceEquals((0f, -7.4f, 0f), TestSphere.ClosestPointOnSurfaceTo(new BoundedLine((0f, -17.4f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 7.4f, 0f), TestSphere.ClosestPointOnSurfaceTo(new BoundedLine((0f, 27.4f, 0f), Direction.Down * 9f)), TestTolerance);
	...
	public void ShouldCorrectlyFindClosestPointOnLineToSurface() {
		...
		Assert.AreEqual(7.4f, TestSphere.ClosestPointToSurfaceOn(new BoundedLine((0f, 0f, 0f), Direction.Down * 100f)).DistanceFromOrigin(), TestTolerance);
		Assert.AreEqual(7.4f, TestSphere.ClosestPointToSurfaceOn(new BoundedLine((0f, 7.4f, 0f), Direction.Down * 100f)).DistanceFromOrigin(), TestTolerance);
		Assert.AreEqual(7.4f, TestSphere.ClosestPointToSurfaceOn(new BoundedLine((0f, -7.4f, 0f), Direction.Up * 100f)).DistanceFromOrigin(), TestTolerance);
		Assert.AreEqual(7.4f, TestSphere.ClosestPointToSurfaceOn(new BoundedLine((0f, 17.4f, 0f), Direction.Down * 100f)).DistanceFromOrigin(), TestTolerance);
		Assert.AreEqual(7.4f, TestSphere.ClosestPointToSurfaceOn(new BoundedLine((0f, -17.4f, 0f), Direction.Up * 100f)).DistanceFromOrigin(), TestTolerance);
		AssertToleranceEquals((0f, 7.4f, 0f), TestSphere.ClosestPointToSurfaceOn(new BoundedLine((0f, 7.4f, 0f), Direction.Up * 100f)), TestTolerance);
		AssertToleranceEquals((0f, -7.4f, 0f), TestSphere.ClosestPointToSurfaceOn(new BoundedLine((0f, -7.4f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 17.4f, 0f), TestSphere.ClosestPointToSurfaceOn(new BoundedLine((0f, 17.4f, 0f), Direction.Up * 100f)), TestTolerance);
		AssertToleranceEquals((0f, -17.4f, 0f), TestSphere.ClosestPointToSurfaceOn(new BoundedLine((0f, -17.4f, 0f), Direction.Down * 100f)), TestTolerance);
		AssertToleranceEquals((0f, 18.4f, 0f), TestSphere.ClosestPointToSurfaceOn(new BoundedLine((0f, 27.4f, 0f), Direction.Down * 9f)), TestTolerance);
	...
	public void ShouldCorrectlyFindLineIntersections() {
		...
		// BoundedLine
		Assert.AreEqual(null, TestSphere.IntersectionWith(new BoundedLine(new Location(0f, 10f, 0f), Direction.Right * 100f)));
		Assert.AreEqual(null, TestSphere.IntersectionWith(new BoundedLine(new Location(10f, 10f, 0f), Direction.Right * 100f)));
		Assert.AreEqual(null, TestSphere.IntersectionWith(new BoundedLine(new Location(-10f, 0f, 0f), Direction.Right * 100f)));
		Assert.AreEqual(null, TestSphere.IntersectionWith(new BoundedLine(new Location(-10f, 0f, 0f), Direction.Left * 2.5f)));

		intersection = TestSphere.IntersectionWith(new BoundedLine(new Location(10f, 6f, 0f), Direction.Right * 100f))!.Value;
		Assert.AreEqual(7.4f, intersection.First.DistanceFromOrigin(), TestTolerance);
		Assert.AreEqual(6f, intersection.First.Y, TestTolerance);
		Assert.AreEqual(7.4f, intersection.Second!.Value.DistanceFromOrigin(), TestTolerance);
		Assert.AreEqual(6f, intersection.Second!.Value.Y, TestTolerance);
		...
		intersection = TestSphere.IntersectionWith(new BoundedLine(new Location(0f, 6f, 0f), Direction.Right * 100f))!.Value;
		Assert.AreEqual(7.4f, intersection.First.DistanceFromOrigin(), TestTolerance);
		Assert.AreEqual(6f, intersection.First.Y, TestTolerance);
		Assert.AreEqual(false, intersection.Second.HasValue);

		intersection = TestSphere.IntersectionWith(new BoundedLine(new Location(10f, 6f, 0f), Direction.Right * 10f))!.Value;
		Assert.AreEqual(7.4f, intersection.First.DistanceFromOrigin(), TestTolerance);
		Assert.AreEqual(6f, intersection.First.Y, TestTolerance);
		Assert.AreEqual(false, intersection.Second.HasValue);

		intersection = TestSphere.IntersectionWith(new BoundedLine(new Location(0f, 7.4f, 0f), Direction.Right * 100f))!.Value;
		AssertToleranceEquals((0f, 7.4f, 0f), intersection.First, TestTolerance);
		Assert.IsFalse(intersection.Second.HasValue);
	}
