...
public:
	...
	static void copy_loaded_asset_mesh_triangles(MemoryLoadedAssetHandle assetHandle, int32_t meshIndex, interop_bool correctFlippedOrientation, interop_bool prebakeTransforms, int32_t bufferSizeTriangles, int32_t* buffer);
	...
	static void get_loaded_asset_texture_path_len(MemoryLoadedAssetHandle assetHandle, int32_t materialIndex, int32_t textureIndex, const char* assetRootDirPath, int32_t* outPathLength);
	...
	static void get_loaded_asset_mesh_skeletal_animation_metadata(MemoryLoadedAssetHandle assetHandle, int32_t animIndex, float_t ticksPerSecOverride, int32_t* outNameLengthBytes, float_t* outDurationSeconds, int32_t* outChannelCount);
