...
public:
	...
	static void set_model_instance_mesh(ModelInstanceHandle modelInstance, VertexBufferHandle vb, IndexBufferHandle ib, int32_t ibStartIndex, int32_t ibCount, float3 aabbCenter, float3 aabbHalfExtents);
