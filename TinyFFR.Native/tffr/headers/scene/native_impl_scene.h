...
public:
	...
	static void create_scene_backdrop_texture(TextureHandle skyboxTexture, TextureHandle iblTexture, float indirectLightingIntensity, float rotAngleRadians, float3 rotAxis, SkyboxHandle* outSkybox, IndirectLightHandle* outIndirectLight);
