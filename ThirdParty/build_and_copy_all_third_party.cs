...
if (OperatingSystem.IsMacOS()) {
	commandLists[LibAssimp].AddRange(
		$"cmake -DCMAKE_INSTALL_PREFIX={InterimInstallDirName} -DCMAKE_BUILD_TYPE={ConfigurationToken} -DASSIMP_BUILD_ZLIB=OFF -DASSIMP_INSTALL=ON -DASSIMP_BUILD_TESTS=OFF \"{RepoRootDirToken}/CMakeLists.txt\"",
